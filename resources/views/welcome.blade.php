    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{ route('satu_pintu') }}" class="navbar-brand"><b>MAN IC</b>&nbsp;Benteng</a>
          <a class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" href="{{ route('login') }}"><i class="fa fa-sign-in"></i>&nbsp;Login</a>
        </div>
        <!-- /.navbar-collapse -->
        <!-- Navbar Right Menu -->
